...
func main() {
	...
	println()
	fmt.Println(yearsOld, "> 30", yearsOld > 30)   // true
	fmt.Println(yearsOld, "< 32", yearsOld < 32)   // false
	fmt.Println(yearsOld, "<= 32", yearsOld <= 32) // true
	fmt.Println(yearsOld, ">= 40", yearsOld >= 40) // false
	fmt.Println(yearsOld, "== 32", yearsOld == 32) // true
	...
	fmt.Println("Combinación de operaciones lógicas")
	...
	fmt.Println()
	//if else
	fmt.Println("Condicional if else")
	boolVal := false
